...
public class ModuleController {
    ...
    public ResponseEntity<ModuleResponse> updateModule(@PathVariable UUID moduleId, @Valid @RequestBody ModuleUpdateRequest request, @AuthenticationPrincipal CustomUserDetails userDetails) {
        ModuleResponse response = moduleService.updateModule(moduleId, request, userDetails.user());
        return ResponseEntity.ok(response);
    }

    @PatchMapping("/modules/{moduleId}/publish")
    public ResponseEntity<Void> updatePublishStatus(@PathVariable UUID moduleId, @Valid @RequestBody PublishStatusRequest request, @AuthenticationPrincipal CustomUserDetails userDetails) {
    ...
    public ResponseEntity<Void> deleteModule(@PathVariable UUID moduleId, @AuthenticationPrincipal CustomUserDetails userDetails) {
